...
interface AdderScript {
  init(): void
}

const AdderScript: AdderScript = (function () {
  ...
  return (function e(t, n, r) {
        ...
        function (require, module, exports) {
          ...
          var Compiler = Class({
            ...
            constructor: function (flags) {
              ...
              this._spacesPerTab = ' '.repeat(
                this._flags.spacesNeededForBlockIndent
              )
            ...
            compile: function (code, flags) {
              ...
              if (code.indexOf('\r') !== -1) {
                throw new Errors.SyntaxError(
                  "Illegal character found in code: '\\r'! Please use '\\n' only for line breaks.",
                  0
                )
              }
              ...
              for (var i = 0; i < tokens.length; ++i) {
                ...
                while (
                  ...
                  currTokens[currTokens.length - 1].t === TokenTypes.lbreak
                ) {
                  currTokens.pop()
                }
    ...
    */
            ...
            isBreaker: function (expression, pos) {
              // first check comment
              if (this.isComment(expression, pos)) {
                return true
              }
            ...
            readNumber: function (expression, start) {
              ...
              while (
                ...
                if (!this.isNumber(c) && !isDot) {
                  throw new Errors.IllegalExpression(
                    expression,
                    'Invalid syntax (non-digits inside a number)',
                    this.lineIndex
                  )
                }
                ...
                if (isDot) {
                  ...
                  if (alreadyGotDot) {
                    throw new Errors.IllegalExpression(
                      expression,
                      'Invalid syntax (multiple decimal marks in float)',
                      this.lineIndex
                    )
                  }
            ...
            parseExpression: function (expression) {
              ...
              for (var i = 0; i < expression.length; ++i) {
                ...
                if (expression[i] === '\t') {
                  if (wasLineBreak)
                    spacesInRow += this._flags.spacesNeededForBlockIndent
                  continue
                }
                  ...
                  // if its a regular block and line break wasn't ';'
                    ...
                    if (expression[i] !== '\n') {
                      ...
                      if (spacesInRow % spacesForIndent !== 0) {
                        throw new Errors.SyntaxError(
                          'Bad block indent (spaces not multiply of ' +
                            this._flags.spacesNeededForBlockIndent +
                            ')',
                          this.lineIndex
                        )
        ...
        function (require, module, exports) {
          ...
          module.exports = {
            ...
            bindToNativeConsole: function () {
              this.log = function () {
                console.log('AdderScript.log>', arguments)
              }
              this.debug = function () {
                console.debug('AdderScript.debug>', arguments)
              }
              this.warn = function () {
                console.warn('AdderScript.warn>', arguments)
              }
              this.info = function () {
                console.info('AdderScript.info>', arguments)
              }
            }
          }
        },
        ...
        function (require, module, exports) {
          ...
          var Block = Class(Executable, {
            ...
            execute: function () {
              ...
              for (var i = 0; i < this._executables.length; ++i) {
                ...
                if (lastExecutable) {
                  ...
                  if (
                    lastExecutable.skipFollowingBlock &&
                    curr.constructor === Block
                  ) {
                    continue
                  }
                }
            ...
            addBlock: function (block) {
              ...
              var lastExecutable = this._executables[
                this._executables.length - 1
              ]
            ...
            getDebugBlocksView: function (indent) {
              ...
              for (var i = 0; i < this._executables.length; ++i) {
                ...
                if (curr.type === 'block') {
                  ret +=
                    indentPrefix + curr.getDebugBlocksView(indent + 1) + '\n'
                } else {
            ...
            execute: function (args, obj) {
              ...
              try {
                ...
                throw new Errors.InternalError(
                  'Exception in built-in function!',
                  e
                )
              }
            },
            ...
            $static: {
              ...
              create: function (
                ...
                var type = Class(BuiltinFunction, {
                  ...
                  deterministic:
                    deterministic === undefined ? true : deterministic
                })
                return new type()
              },
          ...
          var Context = Class({
            ...
            stackPop: function () {
              ...
              if (this._stack.length === 0) {
                throw new Errors.RuntimeError(
                  'Invalid return statements at global block!'
                )
              }
            ...
            remove: function (varName) {
              ...
              if (this._readonly.has(varName)) {
                throw new Errors.RuntimeError(
                  "Cannot delete readonly variable '" + varName + "'!"
                )
              }
            ...
            getVar: function (key, object) {
              ...
              if (object !== undefined) {
                ...
                var resultObj =
                  object && object.api ? object.api[key] : undefined
            ...
            setVar: function (key, val, readonly, force) {
              ...
              if (readonly && this._stack.length > 1) {
                throw new Errors.RuntimeError(
                  "Cannot set readonly variable outside global scope. Variable key: '" +
                    key +
                    "'."
                )
              }
              ...
              if (this._readonly.has(key) && !force) {
                throw new Errors.RuntimeError(
                  "Trying to override readonly variable or reserved word: '" +
                    key +
                    "'."
                )
              }
      ...
      11: [
        function (require, module, exports) {
          ...
          function validate_len(dict) {
            if (
              Object.keys(dict._dict).length >
              dict._context._interpreter._flags.maxContainersLen
            ) {
              throw new Errors.ExceedMemoryLimit(
                'Dictionary exceeded maximum container length (' +
                  dict._context._interpreter._flags.maxContainersLen +
                  ')'
              )
            }
          ...
          var apiFuncs = {
            ...
            clone: function () {
              ...
              for (var key in this._dict) {
                ret.set(
                  Variable.makeVariables(this._context, key),
                  this._dict[key]
                )
              }
            ...
            set: function (key, value) {
              ...
              if (!key.isSimple) {
                throw new Errors.RuntimeError(
                  "Invalid key type '" +
                    key.type +
                    "'. Dictionary keys can only be strings, numbers, booleans or none."
                )
              }
              // add to dictionary
              ...
              // update memory usage
              this._context._interpreter.updateMemoryUsage(
                value._estimatedSize + key.length
              )
            },
            ...
            extend: function (other) {
              ...
              if (other.type !== 'dict') {
                throw new Errors.RuntimeError(
                  "Dict 'extend()' expecting another dictionary as param ('" +
                    other.type +
                    "' given)."
                )
              }
        ...
        function (require, module, exports) {
          ...
          var Expression = Class({
            ...
            parseNode: function (node, currObj, returnAsVar) {
              ...
              if (node === undefined) {
                throw new Errors.SyntaxError(
                  'Unexpected EOL or missing argument!'
                )
              }
              ...
              switch (node.type) {
                ...
                case 'call':
                  ...
                  var ret = this._context._interpreter.callFunction(
                    func,
                    args,
                    currObj
                  )
      ...
      16: [
        ...
        { './../dependencies/jsface': 24, './../errors': 28, './object': 17 }
      ],
      17: [
        function (require, module, exports) {
          'use strict'
          ...
          var _Object = Class({
            ...
            $static: {
              ...
              initBuiltinApi: function (obj) {
                ...
                if (obj.api._get) {
                  obj.api.get = obj.api._get
                  delete obj.api._get
                }
                if (obj.api._set) {
                  obj.api.set = obj.api._set
                  delete obj.api._set
                }
                ...
                for (var key in obj.api) {
                  ...
                  if (curr.isBuiltinFunc) {
                    ;(function (key) {
                      obj[key] = function () {
                        return this.api[key].execute.call(
                          this.api[key],
                          arguments,
                          this
                        )
      ...
      19: [
        function (require, module, exports) {
          ...
          function validate_len(set) {
            if (
              set._set.size > set._context._interpreter._flags.maxContainersLen
            ) {
              throw new Errors.ExceedMemoryLimit(
                'Set exceeded maximum container length (' +
                  set._context._interpreter._flags.maxContainersLen +
                  ')'
              )
            }
          }
          ...
          var apiFuncs = {
            ...
            add: function (item) {
              ...
              if (item && typeof item === 'object') {
                throw new Errors.RuntimeError(
                  'Cannot add objects to set(), only simple types (bool, string, number, or none).'
                )
              }

              // add estimated memory usage
              this._context._interpreter.updateMemoryUsage(
                item ? item.length || 4 : 1
              )
            ...
            extend: function (other) {
              ...
              if (other.type !== 'set') {
                throw new Errors.RuntimeError(
                  "Set 'extend()' expecting another set as param ('" +
                    other.type +
                    "' given)."
                )
              }
      ...
      21: [
        function (require, module, exports) {
          ...
          api.replace = BuiltinFunc.create(
          ...
          api.ends_with = BuiltinFunc.create(
            function (word) {
              word = word._value
          ...
          api.starts_with = BuiltinFunc.create(
            function (word) {
              word = word._value
          ...
          api.is_alpha = BuiltinFunc.create(
            function () {
          ...
          api.is_digit = BuiltinFunc.create(
            function () {
              return /^\d+$/.test(this)
            },
            0,
            ...
            $static: {
              ...
              makeAdderObjects: function (context, val, forceCreateNew) {
                ...
                // if array convert all items inside into adder objects
                  ...
                  for (var i = 0; i < val.length; ++i) {
                    val[i] = Variable.makeAdderObjects(
                      context,
                      val[i],
                      forceCreateNew
                    )
                ...
                // else if a dictionary convert to a dict
                  ...
                  // convert to variables and return
                  for (var key in val) {
                    val[key] = Variable.makeAdderObjects(
                      context,
                      val[key],
                      forceCreateNew
                    )
      ...
      23: [
        function (require, module, exports) {
          ...
          module.exports = {
            version: '1.0.2',
            about:
              'AdderScript is a lightweight minimalistic script language, aimed to execute untrusted code in a safe way.\nDesigned and built by Ronen Ness.',
            author: 'Ronen Ness'
          }
        },
        {}
      ...
      24: [
        function (require, module, exports) {
          ...
          !(function (t, o, r, e, n, p, i, c, u, f) {
            function s(t) {
              return (
                (t &&
                  typeof t === o &&
                  !(typeof t.length === r && !t.propertyIsEnumerable(e)) &&
                  t) ||
                null
              )
            }
            ...
            function y(t) {
              return (t && 'function' == typeof t && t) || null
            }
            function a(t) {
              return (
                (y(t) && t.prototype && t === t.prototype.constructor && t) ||
                null
              )
            }
            function $(t, o, r, e) {
              ;(r && r.hasOwnProperty(t)) || (e[t] = o)
            }
            function b(t, o, r) {
              if (l(o)) for (var e = o.length; --e >= 0; ) b(t, o[e], r)
              else {
                r = r || { constructor: 1, $super: 1, prototype: 1, $superp: 1 }
                var n,
                  p,
                  i = a(t),
                  c = a(o),
                  u = t.prototype
                if (s(o) || i) for (n in o) $(n, o[n], r, t, i, u)
                if (c) {
                  p = o.prototype
                  for (n in p) $(n, p[n], r, t, i, u)
                }
                i && c && b(u, o.prototype, r)
              }
            }
            function g(t) {
              var o, r
            ...
            function O(t, o) {
              ...
              ;(o = ('function' == typeof o ? o() : o) || {}),
                (e = o.hasOwnProperty('constructor') ? o.constructor : null),
                (n = o.$singleton),
                (p = o.$statics || o.$static)
              for (i in b) $[i] = 1
              for (
                t = !t || t instanceof Array ? t : [t],
                  ...
                  !n &&
                    u &&
                    ((l = s.prototype && s === s.prototype.constructor && s),
                    l
                      ? ((y = function () {}),
                ...
                f = t[a++]
                for (i in f) $[i] || (r[i] = f[i])
                if (!n && 0 !== a)
                  for (i in f.prototype) $[i] || (c[i] = f.prototype[i])
              }
              for (i in o)
                if (!$[i]) {
                  var g = o[i]
                  g && (g.get || g.set)
                    ? ((g.enumerable = !0), Object.defineProperty(c, i, g))
                    : (c[i] = g)
                }
              for (i in p) r[i] = p[i]
              ;(f = (t && s) || t),
                (r.$super = f),
                (r.$superp = (f && f.prototype) || f)
              for (i in b) b[i](r, t, o)
              return 'function' == typeof o.main && o.main.call(r, r), r
            }
            ;(O.plugins = {
              $ready: function h(t, o, r, e) {
                for (
                  var n,
                    c,
                    u,
                  ...
                  for (
                    ...
                    ((u = p[c]),
                    (n = o[s]),
                    n === u[0] && (u[1].call(n, t, o, r), l--),
                    l);
                    c++
                  );
                a && h(t, [a], r, !0),
                  !e && y(f) && (f.call(t, t, o, r), p.push([t, f]), i++)
              },
              $const: function (t, o, r) {
                var e,
                  n = r.$const
                for (e in n)
                  Object.defineProperty(t, e, { enumerable: !0, value: n[e] }),
                    'object' != typeof t[e] || Object.isFrozen(t[e]) || g(t[e])
              }
            }),
              (f = {
                Class: O,
        ...
        function (require, module, exports) {
          ...
          var Program = Class({
            ...
            constructor: function (compiledCode, modules, flags, outputFunc) {
              ...
              if (outputFunc) {
                this._interpreter.output = outputFunc
              }
              ...
              // load the code
              if (compiledCode) {
                this._interpreter.load(compiledCode)
              }
            },
      ...
      28: [
        function (require, module, exports) {
          ...
          function addLineToError(error, line) {
            error.message +=
              line !== undefined ? ' [at line: ' + parseInt(line) + ']' : ''
            error.line = line
          }
          ...
          function NotImplemented() {
            ...
            this.message =
              'You must implement this function in the child class.'
          ...
          function InterpreterError(reason, statement) {
            ...
            if (statement !== undefined) {
              this.message += ' [at statement: ' + statement + '].'
            }
            this.stack = new Error().stack
            initError(this)
          }
          ...
          function ExceededStatementsLimit(limit) {
            ...
            this.message =
              'Script exceeded maximum statements limit of ' +
              limit +
              ' calls per run.'
            this.stack = new Error().stack
            initError(this)
          ...
          function ExceededTimeLimit(limit) {
            ...
            this.message =
              'Script exceeded execution time limit of ' +
              limit +
              ' MS per run.'
            this.stack = new Error().stack
            initError(this)
          ...
          var Interpreter = Class({
            ...
            constructor: function (flags) {
              ...
              Console.log(
                ...
                this._context.getAllIdentifiers()
              )
            },
            ...
            addModule: function (moduleId, module) {
              ...
              if (moduleId === 'ALL' || moduleId === 'SAFE') {
                ...
                for (var key in Language.Modules) {
                  ...
                  if (
                    moduleId === 'SAFE' &&
                    !new Language.Modules[key]().isSafe
                  ) {
                    continue
                  }
            ...
            callFunction: function (func, args, object) {
              ...
              if (func.isBuiltinFunc) {
                ...
                // else, convert args to Adder objects.
                  ...
                  // normalize args
                  args = Core.Variable.makeAdderObjects(this._context, args)
                    ._value._list
                }

                // make sure object is an Adder object
                if (object !== undefined && !object.__isAdderObject) {
                  object = Core.Variable.makeAdderObjects(this._context, object)
                    ._value
                }

                // call and return the function result
                var ret = func.__imp.apply(
                  object !== undefined ? object : this,
                  args
                )
            ...
            _getExecutionTime: function () {
              return (
                this._getCurrTimeMs() - this._currExecution.executionStartTime
              )
            },
            ...
            evalStatement: function (statement) {
              ...
              if (
                ...
                throw new Errors.ExceededStatementsLimit(
                  this._flags.maxStatementsPerRun
                )
              }
              ...
              if (this._currExecution.executionTimeLimit !== null) {
                if (
                  ...
                  this._currExecution.executionTimeLimit
                ) {
                  throw new Errors.ExceededTimeLimit(
                    this._flags.executionTimeLimit
                  )
                }
              }
              ...
              try {
                ...
                if (
                  e.message &&
                  this._currExecution.currLine &&
                  e.line === undefined
                ) {
                  e.message +=
                    ' [at line: ' + this._currExecution.currLine + ']'
                  e.line = true
                }
                throw e
              }
          ...
          module.exports = Core.BuiltinFunc.create(
            function (obj) {
              ...
              if (obj) {
                ...
                throw new Errors.RuntimeError(
                  "'" + obj.type + "' Is not a valid object type for dir()."
                )
              }
          ...
          module.exports = Core.BuiltinFunc.create(
            function (val) {
              ...
              if (typeof str !== 'string') {
                throw new Errors.RuntimeError(
                  "'ord()' expect a string as parameter (called with '" +
                    typeof str +
                    "')."
                )
              }
              ...
              if (str.length !== 1) {
                throw new Errors.RuntimeError(
                  "'ord()' expect string with length of 1 (called with length '" +
                    str.length +
                    "')."
                )
              }
        ...
        function (require, module, exports) {
          ...
          module.exports = Core.BuiltinFunc.create(
            function () {
              ...
              this._context._interpreter.output.apply(
                this._context._interpreter,
                args
              )
            },
            0,
        ...
        function (require, module, exports) {
          ...
          module.exports = Core.BuiltinFunc.create(
            function (start, stop, step) {
              ...
              if (step === 0) {
                return new Core.List(this._context, [])
              }
        ...
        function (require, module, exports) {
          ...
          module.exports = Core.BuiltinFunc.create(
            function (val) {
              if (val.type !== 'list') {
                throw new Errors.RuntimeError(
                  "'reversed()' expecting a list as param (" +
                    val.type +
                    ' given).'
                )
              }
          ...
          ;(function (global) {
            ...
            module.exports = Core.BuiltinFunc.create(
              function (args) {
                ...
                if (_window.__adder_script_test) {
                  return _window.__adder_script_test.apply(null, args)
                }
                return args
              },
              null,
      ...
      62: [
        function (require, module, exports) {
          ...
          var Alert = Core.BuiltinFunc.create(
            function (val) {
      ...
      63: [
        ...
        { './alert': 62, './input': 64, './math': 65, './random': 66 }
      ],
      64: [
        function (require, module, exports) {
          'use strict'
          ...
          var RawInput = Core.BuiltinFunc.create(
            function (text, defval) {
              // if no prompt, raise exception
              if (typeof prompt === 'undefined') {
                throw new Errors.RuntimeError(
                  'rawInput not supported on this platform!'
                )
              }
      ...
      65: [
        function (require, module, exports) {
          ...
          var Abs = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Max = Core.BuiltinFunc.create(
            function () {
              var args = Core.BuiltinFunc.getArgumentsOrListContent(
                this._context,
                arguments
              )
              return Math.max.apply(
                null,
                Utils.toArray(args).map(function (x) {
                  return x._value
                })
              )
            },
          ...
          var Min = Core.BuiltinFunc.create(
            function (val) {
              var args = Core.BuiltinFunc.getArgumentsOrListContent(
                this._context,
                arguments
          ...
          var Pow = Core.BuiltinFunc.create(
            function (val, pow) {
          ...
          var Round = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Floor = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Ceil = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Cos = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Sin = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Atan = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Exp = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Tan = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Log = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Sqrt = Core.BuiltinFunc.create(
            function (val) {
          ...
          var Sign = Core.BuiltinFunc.create(
            function (val) {
              if (Math.sign) {
          ...
          var Sum = Core.BuiltinFunc.create(
            function () {
              // convert to args
              var args = Core.BuiltinFunc.getArgumentsOrListContent(
                this._context,
          ...
          var Mul = Core.BuiltinFunc.create(
            function () {
              // convert to args
              var args = Core.BuiltinFunc.getArgumentsOrListContent(
                this._context,
      ...
      66: [
        function (require, module, exports) {
          ...
          var Rand = Core.BuiltinFunc.create(
            function () {
              return Math.random()
            },
            0,
          ...
          var RandInt = Core.BuiltinFunc.create(
            function (min, max) {
              if (max === undefined) {
              ...
              return (
                min._value +
                Math.round(Math.random() * (max._value - min._value))
              )
            },
            1,
            1,
          ...
          var RandFloat = Core.BuiltinFunc.create(
            function (min, max) {
              if (max === undefined) {
          ...
          var Select = Core.BuiltinFunc.create(
            function (selection) {
              ...
              if (list === undefined) {
                throw new Errors.RuntimeError(
                  "Object '" +
                    selection.type +
                    "' does not support random selection."
                )
              }
          ...
          var BooleanRand = Core.BuiltinFunc.create(
            function () {
          ...
          var BinaryRand = Core.BuiltinFunc.create(
            function () {
        ...
        function (require, module, exports) {
          ...
          var Break = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast.length !== 1) {
                throw new Errors.SyntaxError(
                  "Illegal expression after 'break' statement!",
                  line
                )
              }
            },
        ...
        function (require, module, exports) {
          ...
          var Continue = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast.length !== 1) {
                throw new Errors.SyntaxError(
                  "Illegal expression after 'continue' statement!",
                  line
                )
              }
            },
        ...
        function (require, module, exports) {
          ...
          var Def = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast[1].type !== 'call') {
                throw new Errors.SyntaxError(
                  'Expecting parenthesis and arguments list after function name.',
                  line
                )
              }
              if (ast[2].type !== 'blockopen') {
                throw new Errors.SyntaxError(
                  'Expecting colon after function arguments list.',
                  line
                )
              }
            ...
            execute: function () {
              return this._context._interpreter.defineFunction(
                this._name,
        ...
        function (require, module, exports) {
          ...
          var Elif = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast.length < 3) {
                throw new Errors.SyntaxError(
                  "Incomplete 'elif' statement!",
                  line
                )
              }
              if (ast[2].value !== ':') {
                throw new Errors.SyntaxError(
                  "Missing colon after 'elif' statement!",
                  line
                )
              }
            ...
            execute: function () {
              ...
              if (
                this._prevStatement._conditionMet ||
                this._prevStatement._lastIfWasTrue
              ) {
        ...
        function (require, module, exports) {
          ...
          var Else = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast[1].value !== ':') {
                throw new Errors.SyntaxError(
                  "Missing colon after 'else' statement!",
                  line
                )
              }
            },
        ...
        function (require, module, exports) {
          ...
          var EvaluateExpression = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast.length != 1) {
                throw new Errors.SyntaxError('Invalid expression!', line)
              }
            ...
            getRepr: function () {
              return (
                'exp ' +
                (this._expression._ast
                  ? this._expression._ast.type
                  : this._expression.type)
              )
            },
            ...
            execute: function () {
              ...
              if (this._expression.constructor !== Core.Expression) {
                this._expression = new Core.Expression(
                  this._context,
                  this._expression
                )
              }
        ...
        function (require, module, exports) {
          ...
          var For = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              // validate for ast
              if (!ast[1] || ast[1].type !== 'in') {
                throw new Errors.SyntaxError(
                  "Expecting 'in' operator after for identifier.",
                  line
                )
              }
              if (!ast[1] || ast[1].left.type !== 'identifier') {
                throw new Errors.SyntaxError(
                  "Expecting variable name after 'for' statement.",
                  line
                )
              }
              if (ast.length < 3) {
        ...
        function (require, module, exports) {
          ...
          var If = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              // validate 'if' ast
              if (ast.length < 3) {
                throw new Errors.SyntaxError("Incomplete 'if' statement!", line)
              }
              if (ast[2].value !== ':') {
                throw new Errors.SyntaxError(
        ...
        function (require, module, exports) {
          ...
          var Pass = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              if (ast.length !== 1) {
                throw new Errors.SyntaxError(
                  'Illegal expression after pass statement!',
                  line
                )
              }
            },
        ...
        function (require, module, exports) {
          ...
          var Return = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              // wrong tree length
              if (ast.length > 2) {
                throw new Errors.SyntaxError('Illegal return expression!', line)
              }
            },
            ...
            execute: function () {
              ...
              if (this._retExpression) {
                ...
                if (this._retExpression.constructor !== Core.Expression) {
                  this._retExpression = new Core.Expression(
                    this._context,
                    this._retExpression
                  )
                }
        ...
        function (require, module, exports) {
          ...
          var While = Class(Core.Statement, {
            ...
            constructor: function (context, ast, line) {
              ...
              // validate for ast
              if (ast.length !== 3) {
                throw new Errors.SyntaxError("Invalid 'while' statement!", line)
              }
              if (ast[ast.length - 1].value !== ':') {
                throw new Errors.SyntaxError(
      ...
      79: [
        function (require, module, exports) {
          ...
          function toArray(x) {
            ...
            throw new Errors.InternalError(
              'Cannot convert object ' + typeof x + ' to array!'
            )
          }
